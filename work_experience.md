...
- 作为伯明翰大学技能训练营的数据技能讲师，我致力于传授关键的数据技能，特别强调它们在创意产业中的应用。我的职责包括：
    1. 介绍 R 编程：教授学生 R 的基础知识，R 是一种用于数据分析的多功能语言，强调其在创意产业各个部门的应用。
    2. 掌握 R Studio 和 Tidyverse：指导学生深入了解 R Studio 和 Tidyverse 包，强调它们在数据处理和分析中的效率和效果。
    3. R Markdown 指导：展示如何使用 R Markdown 将代码、数据分析和评论整合在一个协调一致、用户友好的格式中。
    4. 数据通信技能：在我的第二课中，我专注于沟通数据的关键技能。这包括教授有效传达数据驱动见解的方法，并促进对数据如何通知和增强创意领域决策过程的理解。
...
- **技能：** 统计数据分析 · 实验设计 · 数据收集 · 良好实验室实践（GLP）

### 社交活动经理
- **混合**
- **2019 年 4 月 - 2023 年 12 月 · 4 年 9 个月**
- 研究团队社交活动协调员：积极管理和组织我们研究团队的社交活动，培养积极和团结的团队环境。职责包括为团队成员策划和执行欢迎会和告别会，展示出强大的组织技能和对细节的关注。此外，我还主动准备个性化生日卡并安排庆祝活动，为团队士气和团队精神做出贡献。这一角色要求创造力、有效沟通和同时管理多项任务的能力，确保成功和难忘的团队聚会。
- **技能：** 研究合作与团队合作

### 研究助理
- **现场**
- **2023 年 3 月 - 10 月 · 8 个月**
- 与 Aengus Ward 教授合作：参与了一项通过眼动追踪分析中世纪西班牙手稿的数字人文学项目。研究设计参与：对初步研究设计和计划做出了贡献，专注于开创性方法论。实验和软件专长：设计并试验了眼动追踪实验，展示了专业软件的熟练使用。数据分析技能：独立进行了高级数据分析，使用描述性分析解释了眼动研究的结果。学术论文合著：共同撰写了一篇研究论文，于 2023 年 10 月提交给了一家领先的数字人文学期刊。多样化技能集：展示了包括实验设计、编程、数据收集、数据分析、统计建模和学术写作在内的一系列技能。
- **技能：** 眼动追踪 · 学术写作 · 分析技能

### 教学助理
- **远程**
- **2020 年 10 月 - 2021 年 3 月 · 6 个月**
- 在基于研究的语言教程中，我为学习各种语言的本科生进行了每周一次的小组在线交流，每次持续三十分钟。这些课程聚焦于对他们的学习既有趣又相关的话题。利用数字技术和学习平台，以及电子邮件，我组织、协调和传递这些沟通和对话会议。此外，我还营造了一个积极和轻松的在线氛围，使学生能够练习和提高他们的外语口语能力，这是他们虚拟留学年项目的一个重要部分。
- **技能：** 高等教育教学 · 大学讲课 · 教学

### IELTS 课程助理
- **远程**
- **2020 年 4 月 - 2020 年 6 月 · 3 个月**
- 课程开发支持：与 John Goodyear 博士，作为现代外语英语讲师，合作准备针对国际学生的 IELTS 课程。教育内容创作：共同创建了一系列 IELTS 准备教学视频，这些视频托管在 Canvas 学习管理系统上。视频制作：独立拍摄和制作了一系列视频，专注于 IELTS 准备技巧和英语学习技能，为全面的在线学习体验做出了贡献。技能和知识分享：利用我在 IELTS 和英语语言教学方面的专长，开发了有效传达 IELTS 成功所需关键策略和技能的内容。
- **技能：** 教授英语为外语

### 学生志愿者
- **现场**
- **2019 年 6 月 · 1 个月**
- 协助组织和促进活动，管理后勤和参与者协调。支持教育会议，协助使用语料库语言学软件，并分发材料。作为与会者的联络人，解答查询并增强他们的体验。
